...
function Blog() {
  ...
  return (
    <section id="blog" className="py-20 bg-base-200 flex flex-col justify-center">
                ...
                <div  className="card-container w-full flex flex-wrap py-20 justify-center gap-2">
    
    
                
    
                    {/* <a  className="card rounded-2xl bg-base-200  max-h-96 shadow-md hover:scale-75" href='https://the-big-bank-theory.beehiiv.com/p/nigerian-women-cracked-the-ceiling-621f947d113f9b1a' target='blank'> */}
    ...
    <div className="sm:p-4 p-2 sm:w-1/2 flex flex-col justify-between">
        <div>
            <p 
                className="block sm:mt-2 text-2xl font-semibold text-gray-50 dark:text-white hover:text-gray-600 hover:underline ">Nigerian Women Cracked the Ceiling</p>
            <p className="mt-2 text-sm text-gray-200 dark:text-gray-400 max-h-20 overflow-ellipsis">{`Now Let's Fix the Floor`} <br/> In June last year, I saw a video of women cheering at a Nigerian bank.
